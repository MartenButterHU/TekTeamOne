...
/// kitt functions
//
/// These functions shows a kitt display on the pins of a port.
/// Each LED is on for m milliseconds. These functions never return.
///
/// Similar functions exist thatb take a port_out or port_oc parameter.
