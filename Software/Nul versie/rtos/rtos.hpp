...
#define RTOS_VERSION "V5.00 (2016-09-22)"
...
public:
   ...
   /// const unsigend long int ms = ...;
   /// const unsigned long int us = ...;
   /// \endcode
   ///
   ...
   static const unsigned long int us = 84;
   static const unsigned long int ms = ( 1000 * us );
   static const unsigned long int  s = ( 1000 * ms );
