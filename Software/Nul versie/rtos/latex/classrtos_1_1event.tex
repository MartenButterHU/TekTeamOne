...
The \hyperlink{classrtos_1_1task__base_a32c6e19fe3d25a38587964defdb52ddc}{task\+::wait()} calls return an event. Such an event can be compared to a waitable. The result is true if and only if the waitable caused the event.
